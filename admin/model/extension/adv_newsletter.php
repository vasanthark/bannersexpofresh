...
class ModelExtensionAdvNewsletter extends Model
{
    
     public function localCheck()
    {
        try {
            new ReflectionMethod('ControllerExtensionModuleAdvancedNewsletter', '_beforeRender');
            return true;
...
<modification>
    ...
    <file path="admin/model/extension/adv_newsletter.php">
