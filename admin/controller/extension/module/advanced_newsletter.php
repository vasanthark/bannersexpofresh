...
class ControllerExtensionModuleAdvancedNewsletter extends Controller {
	...
	public function index() {
		...
		$this->load->model('extension/adv_newsletter');

        $this->model_extension_adv_newsletter->install();
        ...
        $template = 'extension/module/adv_newsletter';
    ...
    protected function getList() {
        ...
        $email_total = $this->model_extension_adv_newsletter->getTotalEmails();

        $results = $this->model_extension_adv_newsletter->getEmails($filter_data);
        ...
        return $this->load->view('extension/module/adv_newsletter_list', $data);
    }
