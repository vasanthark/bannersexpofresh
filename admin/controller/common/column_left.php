...
class ControllerCommonColumnLeft extends Controller {
    ...
    public function index() {
        if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
            ...
            if ($this->user->hasPermission('access', 'catalog/faqcategory')) {
                $faq[] = array(
                    'name' => $this->language->get('text_faqcategory'),
            ...
            if ($catalog) {
                ...
                if ($this->user->hasPermission('access', 'tltblog/tltblog')) {
                    $tltblog[] = array(
                     ...
                     $tltblog[] = array(
                        'name' => "Reviews",
                        'href' => $this->url->link('tltblog/reviews', 'token=' . $this->session->data['token'], true),
                        'children' => array()
                    );
                }
