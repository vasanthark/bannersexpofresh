    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-html" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-seo"><span data-toggle="tooltip" title="<?php echo $help_seo; ?>"><?php echo $entry_seo; ?></span></label>
            <div class="col-sm-10">
              <select name="tltblog_seo" id="input-status" class="form-control">
                <?php if ($tltblog_seo && (!$global_seo_off)) { ?>
              ...
              <?php if ($global_seo_off) { ?>
              <div class="text-danger"><?php echo $error_seo_disabled; ?></div>
              <?php } ?>
            </div>
          </div>
          <div class="form-group">
