...
class ControllerInformationFaq extends Controller {
    ...
    public function index() {
        ...
        $this->document->addStyle('catalog/view/theme/bannerstandsdepot/css/faq.css');
        ...
        if ($faqcategories) {
            ...
            $this->response->setOutput($this->load->view('information/faq_list', $data));
        } else {
    ...
    public function faq_single() {
        ...
        $faq_results = $this->model_catalog_faq->getFaq($faq_id);



        if ($faq_results) {
            
            $data['title'] = $faq_results['title'];
            $data['description'] = html_entity_decode($faq_results['description'], ENT_QUOTES, 'UTF-8');
            $data['text_empty'] = $this->language->get('text_empty');
            ...
            $this->response->setOutput($this->load->view('information/faq_single', $data));
        } else {
            $url = '';

            if (isset($this->request->get['faq_id'])) {
                $url .= '&faq_id=' . $this->request->get['faq_id'];
            }
