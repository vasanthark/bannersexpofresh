...
class ControllerTestimonialTestimonial extends Controller
{
    ...
    public function review() {
        ...
        $data['results'] = sprintf($this->language->get('text_pagination'), ($review_total) ? (($page - 1) * 10) + 1 : 0, ((($page - 1) * 10) > ($review_total - 10)) ? $review_total : ((($page - 1) * 10) + 5), $review_total, ceil($review_total / 10));
